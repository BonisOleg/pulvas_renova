...
_UNIVERSAL_MATERIALS: list[dict] = [
    {
        ...
        "text": "Добірна шкіра та якісний текстиль, що зберігають форму і вигляд навіть після тривалого використання.",
    },
    {
        "num": "02",
        "title": "Надійна фурнітура",
        "text": "Міцні замки та металеві деталі, що не тьмяніють і забезпечують довговічність.",
    },
    {
        "num": "03",
        "title": "Бездоганна збірка",
        "text": "Акуратні подвійні шви, точна геометрія та контроль кожної деталі.",
    },
    {
        "num": "04",
